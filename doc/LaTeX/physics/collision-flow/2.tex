...
ここで， 式 \eqref{eq:get-tile-ijk} の \(f_i, f_j, f_k\) を用いて
\begin{align}
  \begin{gathered}
    i_- \coloneqq f_i(a - r), \quad i_+ \coloneqq f_i(a + r), \\
    j_- \coloneqq f_j(b - r), \quad j_+ \coloneqq f_j(b + r), \\
    k_- \coloneqq f_k(c - r), \quad k_+ \coloneqq f_k(c + r)
  \end{gathered}
\end{align}
とすると，求めるタイルは
\begin{gather*}
